...
#define MOD_LCD_ID   0x04
#define MLCD_TEXT    1

#define MOD_IO_LED               0x05
#define IO_GET_BUTTONS           0x01
#define IO_GET_BUTTONS_LEN       3
#define IO_GET_BUTTONS_DATA_LEN  2

#define IO_GREEN_LED    0x10
#define IO_RED_LED      0x11
#define IO_YELLOW_LED   0x12
#define IO_LED_LEN      4
...
#if 1
  if( count % 3 == 2 ) {
  outBuff[0] = makeHeader( IO_GET_BUTTONS_LEN-3 );
  outBuff[1] = MOD_IO_LED;
  outBuff[2] = IO_GET_BUTTONS;
...
#if 0
  outBuff[0] = makeHeader( IO_LED_LEN-3 );
  outBuff[1] = MOD_IO_LED;
//  outBuff[2] = IO_GREEN_LED;
//  outBuff[2] = IO_RED_LED;
  outBuff[2] = IO_YELLOW_LED;
  if( count % 3 == 0 ) {
    outBuff[3] = 0;
  } else {
    outBuff[3] = 1;
