...
extern uint8_t pageBuffer[PAGE_SIZE] __attribute__ ((section (".noinit")));
...
{    
   ...
   //Buffer the entire page..moved into this function.
...
//      if ((Usi_Data >> 1) == USI_TWI_SlaveAddress)
      if ((Usi_Data >> 1) == (USI_TWI_SlaveAddress>>1) )			// BUG FiX..1-24-2017 ndp
      {
