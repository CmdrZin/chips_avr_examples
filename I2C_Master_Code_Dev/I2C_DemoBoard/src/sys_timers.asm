...
// Add specific labels here for time tic flag consumption.
// NOTE: For more or fewer flags, adj code in st_tmr0_intr() and comments here.
;
; 1ms tic flags
.equ	DELAY_1MS_TIC	= GPIOR00		; General purpose 1ms delay tic
.equ	MS_1MS_TIC		= GPIOR01		; Master Service 1ms TIC
.equ	I2C_10MS_TIC				= GPIOR02		; 
;.equ					= GPIOR03		; 
; 10ms tic flags
.equ	SWITCH_10MS_TIC	= GPIOR04		;
.equ	KP_DS_SW_10MS	= GPIOR05		; KeyPad, Display, and Switch
.equ	LED_10MS_TIC	= GPIOR06		; LED service
.equ	MS_10MS_TIC		= GPIOR07		; Master Service 10ms TIC

.equ	SLOW_TIC		= 5			; 1ms * N for the slow tic
 ...
 * resources:	R16
 *
 * NOTE: Approx 1ms .. 2.4% error
 */
st_init_tmr0:
	ldi		R16, 79				; 2 * 256 * (1 + OCR0A) : 512 * (40*2) : 1024 * 20 * 2
	out		OCR0A, R16
	ldi		R16, (1<<WGM01)
	out		TCCR0A, R16
	ldi		R16, (1<<OCIE0A)
