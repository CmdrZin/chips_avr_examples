 ...
 *
 * Target: LCD_CDM-116100 Demo Board, 8MHz, Sumo Bot
 *
 * Resources
 * SRAM
 *
...
.equ	DEMO_MODE_AVOID		= 3		; avoid black line
...
; Go forward
	ldi		R17, PWM_R_MED_F
;;;	ldi		R17, PWM_R_MED_R			; run backwards
	call	pwm_set_right

	ldi		R17, PWM_L_MED_F
;;;	ldi		R17, PWM_L_MED_R			; run backwards
	call	pwm_set_left
;
	ldi		R16, 200
...
;;	cpi		R16, FLOOR_STATUS_LEFT | FLOOR_STATUS_CENTER | FLOOR_STATUS_RIGHT
;;	brne	sd_skip211
	andi	R16, FLOOR_STATUS_CENTER	; test center only
	brne	sd_skip211
